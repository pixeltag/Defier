...
<article id="post-<?php the_ID(); ?>" class="single-Wrapper" <?php post_class(); ?>  >
    <div class="grid">
                    ...
                    <?php
                      ...
                      the_post_thumbnail();
                          ...
                          <div class="post-type-format"><i class="fa <?php echo esc_html($post_format_icon); ?>"></i></div>
                           <?php if(!empty($defTheme['BreadcrumbsOn'])): ?> <?php Defier_breadcrumbs() ?><?php endif; ?>
                           <div class="mouse-icon">
                           <div id="scrollDown"> <div class="mouse"><div class="wheel"></div></div><div><span class="unu"></span> <span class="doi"></span> <span class="trei"></span> </div>
                              </div></div>
                					</figcaption>
                				</figure>
                        </div>
                        <section class="post-content-wrapper col-md-9 col-lg-9 col-sm-12 col-xs-12">
                            	<header class="entry-header">
                                         <div class="meta-first-row">
                                             <?php if($defTheme['ShowAuthorLabel']): ?>
                                ...
                                <div class="post-format-entry">
                                 <?php
                                    		...
                                    		<div class="link-post-format-content">
                                    			<?php if(!empty($link)) : ?>
                                                  ...
                                                  <i class="fa-link2" aria-hidden="true"></i>
                                    					    	<b class="link"> <?php echo esc_html($link); ?></b></a>
                                    				</h2>
                                    			<?php endif; ?>
                                    		</div>
                                    	</div>
                                  ...
                                  <!-- .entry-footer -->
                                    ...
                                    <section class="post-info-wrapper col-md-9 col-lg-9 col-sm-11 col-xs-12">
                                      <!-- show author -->
                                        <?php global $defTheme; if($defTheme['ShowAuthorBox'] && (is_single())  ): ?>
                                            <?php get_template_part( '/inc/post-formats/parts/author', 'info' ); ?>
                                        <?php endif; ?>
                                      <!-- show author -->
                                      <?php defier_setPostViews(); ?>
                                        <!-- templates here -->
                                        <?php if($defTheme['ShowNextPrevPost']): ?>
                                          <?php get_template_part( 'inc/post-formats/parts/nav', 'post' );  ?>
                                        <?php endif; ?>

                                    </section>
                                                <?php if($defTheme['ShowRelatedPostBox'] && (is_single()) ): ?>
