...
/************ light Block ************/
/*************************************/
class defier_light_block extends Wp_Widget {
	function __construct () {
  parent::__construct(false ,$name = do_shortcode('Defier Block | light', 'defier'));
	...
	function widget($arags ,$instance)
	{
		...
		?>
		<div class="defier-block-box"> <section class="highlights-full">
			<?php
		    ...
		    if(function_exists('defier_cat_color')){
                   ...
                   <?php
											...
											// end block category
		                  ?>
       <ul class="defier-posts-list halfTohalf">
              <?php global $defTheme; ?>
			       		<li class = "defier-first-post col-md-6 col-lg-6 col-sm-6 col-xs-12">
										<div class="grid">
...
register_widget('defier_light_block') ;
});
?>
