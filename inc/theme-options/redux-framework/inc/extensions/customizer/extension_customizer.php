    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
                        ...
                        if ( $option['type'] != "heading" && $option['type'] != "import_export" && $option['type'] != "options_object" && ! empty( $option['type'] ) ) {
                            $wp_customize->add_setting( $option['id'],
                                array(
                                    ...
                                    'type'              => 'option',
                                    'capabilidefier-magazine-blogs'      => 'edit_theme_options',
                                    //'capabilidefier-magazine-blogs'   => $this->parent->args['page_permissions'],
                                    'transport'         => 'refresh',
                                    'theme_supports'    => '',
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'defier' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'defier' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'defier' ),
