<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
    <h1><?php _e( 'Redux Framework - Support', 'defier' ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'We are an open source project used by developers to make powerful control panels.', 'defier' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <div id="support_div" class="support">
        ...
        <form id="supportform">
            ...
            <ul id="progressbar" class=" breadcrumb">
                <li class="active"><?php _e( 'Generate a Support URL', 'defier' ); ?></li>
                <li href="#"><?php _e( 'Select Support Type', 'defier' ); ?></li>
                <li href="#"><?php _e( 'How to Get Support', 'defier' ); ?></li>
            </ul>

            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title"><?php _e( 'Submit a Support Request', 'defier' ); ?></h2>

                <h3 class="fs-title"
                    style="margin-top:0;"><?php _e( 'To get started, we will need to generate a support hash.', 'defier' ); ?></h3>

                <p><?php
                        echo sprintf( wp_kses( __( 'This will provide to your developer all the information they may need to remedy your issue. This action WILL send information securely to a remote server. To see the type of information sent, please look at the  <a href="%s">Status tab</a>.', 'defier' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'tools.php?page=redux-status' ) ) );
                    ?>
                </p>

                <p><a href="#" class="docs button button-primary button-large redux_support_hash"><?php _e( 'Generate
                        a Support URL', 'defier' ); ?></a></p>
                <input type="button" name="next" class="next hide action-button"
                       value="Next"/>
            </fieldset>

            <fieldset>
                <h2 class="fs-title"><?php _e( 'Select Your Support Type', 'defier' ); ?></h2>

                <h3 class="fs-subtitle" style="text-align: center;">
                    <?php _e( 'What type of user are you?', 'defier' ); ?>
                </h3>

                <table id="user_type">
                    <tr>
                        <td id="is_user"><i class="el el-user"></i><br/><?php _e( 'User', 'defier' ); ?><br/>
                            <small><?php _e( 'I am a user, using a pre-built product.', 'defier' ); ?></small>
                        </td>
                        <td id="is_developer"><i
                                class="el el-github"></i><br/><?php _e( 'Developer', 'defier' ); ?><br/>
                            <small><?php _e( 'I am a developer, building a product using Redux.', 'defier' ); ?></small>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset id="final_support">
                <h2 class="fs-title"><?php _e( 'How to Get Support', 'defier' ); ?></h2>

                <div class="is_developer">
                    <p><?php _e( 'Please proceed to the Redux Framework issue tracker and supply us with your support URL below. Please also provide any information that will help us to reproduce your issue.', 'defier' ); ?></p>
                ...
                <div class="is_user">
                    ...
                    <p>
                        <strong><?php _e( 'Please be sure to include for your developer - via cut and paste - the Support URL in the box below.', 'defier' ); ?></strong>
                    </p>
                    <?php
                    ...
                    <!--                    for="p-->
                    <?php //echo $dirname; ?><!--"><strong>--><?php //_e( 'Plugin', 'defier' );?>
                    ...
                    <!--            for="-->
                    <?php //echo sanitize_html_class( $active_theme->Name ); ?><!--"><strong>--><?php //_e( 'Theme', 'defier' ); ?>
                ...
                <p><em>
                        <?php
                            echo sprintf( wp_kses( __( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'defier' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.reduxframework.com/core/support-defined/' ) );
                        ?>
                    </em>
