            ...
            function( $ ) {
                ...
                CHECKS = PROTOTYPE.checks = {
                    builtin: {
                        ...
                        // Properdefier-magazine-blogs which require event reassignment
                ...
                PROTOTYPE.toggle = function( state, event ) {
                    ...
                    // Execute state specific properdefier-magazine-blogs
                    if ( state ) {
                    ...
                    // Define post-animation, state specific properdefier-magazine-blogs
                    after = $.proxy(
                        function() {
                            if ( state ) {
                ...
                $.extend(
                    Tip.prototype, {
                        ...
                        _parseCorner: function( corner ) {
                            ...
                            // Detect corner and mimic properdefier-magazine-blogs
                        ...
                        update: function( corner, position ) {
                            ...
                            // Otherwise inherit mimic properdefier-magazine-blogs from the corner object as necessary
                            else {
                        ...
                        reposition: function( event, api, pos, viewport ) {
                            ...
                            // Setup tip offset properdefier-magazine-blogs
                    ...
                    Ie6.prototype, {
                        ...
                        redraw: function() {
                            ...
                            // Simulate max/min width if not set width present...
                                ...
                                // Grab our max/min properdefier-magazine-blogs
