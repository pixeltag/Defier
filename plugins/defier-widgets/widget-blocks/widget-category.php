...
add_action( 'widgets_init', 'defier_posts_widget' );
function defier_posts_widget() {
...
class categort_posts extends WP_Widget {
    ...
    function categort_posts() {
        ...
        parent::__construct( 'categort-posts-widget','Defier widget - Category Posts', $widget_ops, $control_ops );
    }
    ...
    function widget( $args, $instance ) {
        ...
        echo $before_widget;
                ...
                <ul class="timeline">
                    <?php defier_posts_cat($no_of_posts , $cats_id)?>
                </ul>
        <div class="clear"></div>
    <?php
        echo $after_widget;
