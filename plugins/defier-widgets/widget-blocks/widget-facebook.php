...
class Widget_Facebook extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'facebook-widget','Defier Widget- facebook', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			<div class="facebook_widget">
                <iframe src="//www.facebook.com/plugins/likebox.php?href=<?php echo $facebook_link ; ?>&amp;colorscheme=light&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=false&amp;appId=339241069581293" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:258px;" allowTransparency="true" width=<?php echo $width ; ?>&amp;></iframe>
			</div>
